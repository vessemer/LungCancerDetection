...
def ResNet50(weights='imagenet',
             input_tensor=None, out=3, dim=224):
    ...
    bottle_neck = AveragePooling2D((7, 7), name='avg_pool')(x)

    x = Flatten()(bottle_neck)
    x = Dense(out, activation='sigmoid', name='fc1000')(x)
...
def load_weighs(model, include_top=True):
